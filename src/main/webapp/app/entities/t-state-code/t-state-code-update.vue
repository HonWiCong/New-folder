      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tStateCode.stateName')" for="t-state-code-stateName">State Name</label>
            <input
              type="text"
              class="form-control"
              name="stateName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tStateCode.stateCode')" for="t-state-code-stateCode">State Code</label>
            <input
              type="text"
              class="form-control"
              name="stateCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tStateCode.enteredBy')" for="t-state-code-enteredBy">Entered By</label>
            <input
              type="number"
              class="form-control"
              name="enteredBy"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tStateCode.modifyBy')" for="t-state-code-modifyBy">Modify By</label>
            <input
              type="number"
              class="form-control"
              name="modifyBy"
              id="t-state-code-modifyBy"
              data-cy="modifyBy"
              :class="{ valid: !$v.tStateCode.modifyBy.$invalid, invalid: $v.tStateCode.modifyBy.$invalid }"
              v-model.number="$v.tStateCode.modifyBy.$model"
            />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select
              class="form-control"
              id="t-state-code-tCountryCode"
              data-cy="tCountryCode"
              name="tCountryCode"
              v-model="tStateCode.tCountryCode"
            >
