    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.modifiedBy')" for="t-city-code-modifiedBy">Modified By</label>
            <input
              type="number"
              class="form-control"
              name="modifiedBy"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.tStateCode')" for="t-city-code-tStateCode">T State Code</label>
            <select class="form-control" id="t-city-code-tStateCode" data-cy="tStateCode" name="tStateCode" v-model="tCityCode.tStateCode">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="
                  tCityCode.tStateCode && tStateCodeOption.id === tCityCode.tStateCode.id ? tCityCode.tStateCode : tStateCodeOption
                "
