...
describe('TTitleCode e2e test', () => {
  ...
  describe('new TTitleCode page', () => {
    ...
    it('should create an instance of TTitleCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T18:03').blur().should('have.value', '2024-01-08T18:03');

      cy.get(`[data-cy="modifiedBy"]`).type('60337').should('have.value', '60337');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-09T02:14').blur().should('have.value', '2024-01-09T02:14');
