...
describe('TStateCode e2e test', () => {
  ...
  describe('TStateCode page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit TStateCode page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('TStateCode');
  ...
  describe('new TStateCode page', () => {
    ...
    it('should create an instance of TStateCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-09T02:45').blur().should('have.value', '2024-01-09T02:45');

      cy.get(`[data-cy="modifyBy"]`).type('44722').should('have.value', '44722');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-09T03:44').blur().should('have.value', '2024-01-09T03:44');
