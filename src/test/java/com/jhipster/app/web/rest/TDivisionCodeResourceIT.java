...
class TDivisionCodeResourceIT {
    ...
    void createTDivisionCode() throws Exception {
        ...
        assertThat(testTDivisionCode.getModifiedBy()).isEqualTo(DEFAULT_MODIFIED_BY);
    ...
    void putExistingTDivisionCode() throws Exception {
        ...
        assertThat(testTDivisionCode.getModifiedBy()).isEqualTo(UPDATED_MODIFIED_BY);
    ...
    void partialUpdateTDivisionCodeWithPatch() throws Exception {
        ...
        partialUpdatedTDivisionCode.enteredBy(UPDATED_ENTERED_BY).enteredDate(UPDATED_ENTERED_DATE).modifiedBy(UPDATED_MODIFIED_BY);
