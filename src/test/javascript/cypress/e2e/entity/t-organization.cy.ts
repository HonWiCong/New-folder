...
describe('TOrganization e2e test', () => {
  ...
  describe('new TOrganization page', () => {
    ...
    it('should create an instance of TOrganization', () => {
      ...
      cy.get(`[data-cy="orgPoTaxInclusive"]`).type('indexing demand-driven Borders').should('have.value', 'indexing demand-driven Borders');
      ...
      cy.get(`[data-cy="orgOffPhone3"]`).type('Incredible Fantastic Berkshire').should('have.value', 'Incredible Fantastic Berkshire');
      ...
      cy.get(`[data-cy="orgContpHp"]`).type('collaborative Granite compressing').should('have.value', 'collaborative Granite compressing');
      ...
      cy.get(`[data-cy="confirmedDate"]`).type('2024-01-08T16:22').blur().should('have.value', '2024-01-08T16:22');

      cy.get(`[data-cy="enteredBy"]`).type('87582').should('have.value', '87582');

      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T04:23').blur().should('have.value', '2024-01-08T04:23');

      cy.get(`[data-cy="modifiedBy"]`).type('74017').should('have.value', '74017');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T21:59').blur().should('have.value', '2024-01-08T21:59');
