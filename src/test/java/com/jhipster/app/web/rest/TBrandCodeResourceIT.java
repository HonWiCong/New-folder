...
class TBrandCodeResourceIT {
    ...
    void createTBrandCode() throws Exception {
        ...
        assertThat(testTBrandCode.getModifyBy()).isEqualTo(DEFAULT_MODIFY_BY);
    ...
    void putExistingTBrandCode() throws Exception {
        ...
        assertThat(testTBrandCode.getModifyBy()).isEqualTo(UPDATED_MODIFY_BY);
    ...
    void partialUpdateTBrandCodeWithPatch() throws Exception {
        ...
        partialUpdatedTBrandCode.modifyBy(UPDATED_MODIFY_BY);
