...
describe('TDivisionCode e2e test', () => {
  ...
  describe('new TDivisionCode page', () => {
    ...
    it('should create an instance of TDivisionCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-09T03:28').blur().should('have.value', '2024-01-09T03:28');

      cy.get(`[data-cy="modifiedBy"]`).type('4092').should('have.value', '4092');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T12:21').blur().should('have.value', '2024-01-08T12:21');
