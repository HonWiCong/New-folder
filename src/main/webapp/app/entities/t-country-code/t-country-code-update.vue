    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCountryCode.modifyBy')" for="t-country-code-modifyBy">Modify By</label>
            <input
              type="number"
              class="form-control"
              name="modifyBy"
              id="t-country-code-modifyBy"
              data-cy="modifyBy"
              :class="{ valid: !$v.tCountryCode.modifyBy.$invalid, invalid: $v.tCountryCode.modifyBy.$invalid }"
              v-model.number="$v.tCountryCode.modifyBy.$model"
            />
          </div>
          <div class="form-group">
