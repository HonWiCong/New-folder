...
<template>
	<form name="editForm" role="form" novalidate v-on:submit.prevent="save()" v-if="applicationUserAccount">
		<section class="mt-3">
			<div class="table-title bg-primary">User Details</div>
		...
		<div>
			<div class="table-title bg-primary">Miscellanous Access Right</div>
			<div class="d-flex">
		...
		<div>
			...
			<div class="table-title bg-primary">User Roles</div>
