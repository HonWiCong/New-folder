...
describe('TCountryCode e2e test', () => {
  ...
  describe('TCountryCode page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit TCountryCode page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('TCountryCode');
  ...
  describe('new TCountryCode page', () => {
    ...
    it('should create an instance of TCountryCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T21:49').blur().should('have.value', '2024-01-08T21:49');

      cy.get(`[data-cy="modifyBy"]`).type('14595').should('have.value', '14595');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T20:40').blur().should('have.value', '2024-01-08T20:40');
