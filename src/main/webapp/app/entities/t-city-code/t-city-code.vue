      ...
      <table class="table table-striped" aria-describedby="tCityCodes">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('sainsApp.tCityCode.modifyBy')">Modify By</span></th>
            <th scope="row"><span v-text="$t('sainsApp.tCityCode.modifiedDate')">Modified Date</span></th>
            <th scope="row"><span v-text="$t('sainsApp.tCityCode.tDivisionCode')">T Division Code</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="tCityCode in tCityCodes" :key="tCityCode.id" data-cy="entityTable">
            ...
            <td>{{ tCityCode.modifyBy }}</td>
            <td>{{ tCityCode.modifiedDate ? $d(Date.parse(tCityCode.modifiedDate), 'short') : '' }}</td>
            <td>
              <div v-if="tCityCode.tDivisionCode">
                <router-link :to="{ name: 'TDivisionCodeView', params: { tDivisionCodeId: tCityCode.tDivisionCode.id } }">{{
                  tCityCode.tDivisionCode.id
                }}</router-link>
              </div>
            </td>
            <td class="text-right">
