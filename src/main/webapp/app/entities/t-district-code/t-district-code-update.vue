    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tDistrictCode.modifiedBy')" for="t-district-code-modifiedBy"
              >Modified By</label
            >
            <input
              type="number"
              class="form-control"
              name="modifiedBy"
              id="t-district-code-modifiedBy"
              data-cy="modifiedBy"
              :class="{ valid: !$v.tDistrictCode.modifiedBy.$invalid, invalid: $v.tDistrictCode.modifiedBy.$invalid }"
              v-model.number="$v.tDistrictCode.modifiedBy.$model"
            />
          </div>
          <div class="form-group">
