...
describe('TIndustryCode e2e test', () => {
  ...
  describe('new TIndustryCode page', () => {
    ...
    it('should create an instance of TIndustryCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T06:53').blur().should('have.value', '2024-01-08T06:53');

      cy.get(`[data-cy="modifyBy"]`).type('85665').should('have.value', '85665');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T21:06').blur().should('have.value', '2024-01-08T21:06');
