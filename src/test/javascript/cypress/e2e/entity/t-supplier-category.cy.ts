...
describe('TSupplierCategory e2e test', () => {
  ...
  describe('new TSupplierCategory page', () => {
    ...
    it('should create an instance of TSupplierCategory', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T11:38').blur().should('have.value', '2024-01-08T11:38');

      cy.get(`[data-cy="modifiedBy"]`).type('70986').should('have.value', '70986');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-09T02:40').blur().should('have.value', '2024-01-09T02:40');
