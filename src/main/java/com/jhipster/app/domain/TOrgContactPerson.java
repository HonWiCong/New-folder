...
public class TOrgContactPerson implements Serializable {
	...
	@JsonIgnoreProperties(value = { "contactPersons" }, allowSetters = true)
	...
	public void setOrganization(TOrganization tOrganization) {
		this.organization = tOrganization;
	}

	public TOrgContactPerson organization(TOrganization tOrganization) {
		this.setOrganization(tOrganization);
		return this;
	}
