...
describe('TDistrictCode e2e test', () => {
  ...
  describe('new TDistrictCode page', () => {
    ...
    it('should create an instance of TDistrictCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T21:29').blur().should('have.value', '2024-01-08T21:29');

      cy.get(`[data-cy="modifiedBy"]`).type('44139').should('have.value', '44139');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T16:26').blur().should('have.value', '2024-01-08T16:26');
