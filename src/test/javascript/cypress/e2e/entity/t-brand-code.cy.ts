...
describe('TBrandCode e2e test', () => {
  ...
  describe('new TBrandCode page', () => {
    ...
    it('should create an instance of TBrandCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T13:51').blur().should('have.value', '2024-01-08T13:51');

      cy.get(`[data-cy="modifyBy"]`).type('88933').should('have.value', '88933');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T10:54').blur().should('have.value', '2024-01-08T10:54');
