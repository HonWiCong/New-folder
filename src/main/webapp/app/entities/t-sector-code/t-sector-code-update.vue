    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tSectorCode.modifyBy')" for="t-sector-code-modifyBy">Modify By</label>
            <input
              type="number"
              class="form-control"
              name="modifyBy"
              id="t-sector-code-modifyBy"
              data-cy="modifyBy"
              :class="{ valid: !$v.tSectorCode.modifyBy.$invalid, invalid: $v.tSectorCode.modifyBy.$invalid }"
              v-model.number="$v.tSectorCode.modifyBy.$model"
            />
          </div>
          <div class="form-group">
