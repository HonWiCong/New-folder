...
describe('TSmTax e2e test', () => {
  ...
  describe('new TSmTax page', () => {
    ...
    it('should create an instance of TSmTax', () => {
      ...
      cy.get(`[data-cy="smTaxEnteredDate"]`).type('2024-01-08T21:32').blur().should('have.value', '2024-01-08T21:32');

      cy.get(`[data-cy="smTaxModifiedBy"]`).type('42754').should('have.value', '42754');

      cy.get(`[data-cy="smTaxModifiedDate"]`).type('2024-01-08T22:30').blur().should('have.value', '2024-01-08T22:30');

      cy.get(`[data-cy="smTaxConfirmedBy"]`).type('23895').should('have.value', '23895');

      cy.get(`[data-cy="smTaxConfirmedDate"]`).type('2024-01-08T08:51').blur().should('have.value', '2024-01-08T08:51');
