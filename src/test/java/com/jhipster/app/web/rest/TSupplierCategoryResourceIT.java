...
class TSupplierCategoryResourceIT {
    ...
    void createTSupplierCategory() throws Exception {
        ...
        assertThat(testTSupplierCategory.getModifiedBy()).isEqualTo(DEFAULT_MODIFIED_BY);
    ...
    void putExistingTSupplierCategory() throws Exception {
        ...
        assertThat(testTSupplierCategory.getModifiedBy()).isEqualTo(UPDATED_MODIFIED_BY);
    ...
    void partialUpdateTSupplierCategoryWithPatch() throws Exception {
        ...
        partialUpdatedTSupplierCategory.spcCategory(UPDATED_SPC_CATEGORY).enteredDate(UPDATED_ENTERED_DATE).modifiedBy(UPDATED_MODIFIED_BY);
