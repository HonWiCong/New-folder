...
describe('TSectorCode e2e test', () => {
  ...
  describe('new TSectorCode page', () => {
    ...
    it('should create an instance of TSectorCode', () => {
      ...
      cy.get(`[data-cy="enteredDate"]`).type('2024-01-08T13:04').blur().should('have.value', '2024-01-08T13:04');

      cy.get(`[data-cy="modifiedBy"]`).type('9276').should('have.value', '9276');

      cy.get(`[data-cy="modifiedDate"]`).type('2024-01-08T09:58').blur().should('have.value', '2024-01-08T09:58');
