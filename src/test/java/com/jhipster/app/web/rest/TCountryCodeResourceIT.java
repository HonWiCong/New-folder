...
class TCountryCodeResourceIT {
    ...
    void createTCountryCode() throws Exception {
        ...
        assertThat(testTCountryCode.getModifyBy()).isEqualTo(DEFAULT_MODIFY_BY);
    ...
    void putExistingTCountryCode() throws Exception {
        ...
        assertThat(testTCountryCode.getModifyBy()).isEqualTo(UPDATED_MODIFY_BY);
    ...
    void partialUpdateTCountryCodeWithPatch() throws Exception {
        ...
        partialUpdatedTCountryCode.enteredBy(UPDATED_ENTERED_BY).modifyBy(UPDATED_MODIFY_BY).orgCustomerType(UPDATED_ORG_CUSTOMER_TYPE);
