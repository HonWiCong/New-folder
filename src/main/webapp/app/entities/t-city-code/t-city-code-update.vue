      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.cityCode')" for="t-city-code-cityCode">City Code</label>
            <input
              type="text"
              class="form-control"
              name="cityCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.cityName')" for="t-city-code-cityName">City Name</label>
            <input
              type="text"
              class="form-control"
              name="cityName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.enteredBy')" for="t-city-code-enteredBy">Entered By</label>
            <input
              type="number"
              class="form-control"
              name="enteredBy"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.modifyBy')" for="t-city-code-modifyBy">Modify By</label>
            <input
              type="number"
              class="form-control"
              name="modifyBy"
              id="t-city-code-modifyBy"
              data-cy="modifyBy"
              :class="{ valid: !$v.tCityCode.modifyBy.$invalid, invalid: $v.tCityCode.modifyBy.$invalid }"
              v-model.number="$v.tCityCode.modifyBy.$model"
            />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('sainsApp.tCityCode.tDivisionCode')" for="t-city-code-tDivisionCode"
              >T Division Code</label
            >
            <select
              class="form-control"
              id="t-city-code-tDivisionCode"
              data-cy="tDivisionCode"
              name="tDivisionCode"
              v-model="tCityCode.tDivisionCode"
            >
              <option v-bind:value="null"></option>
              <option
                v-bind:value="
                  tCityCode.tDivisionCode && tDivisionCodeOption.id === tCityCode.tDivisionCode.id
                    ? tCityCode.tDivisionCode
                    : tDivisionCodeOption
                "
